...
Bench::Bench(float angle)
{
	...
	model = glm::translate(model, glm::vec3(0.0f, 56.0f, -28.0f));
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 56.0f, -8.0f));
	meshesw.push_back(woodenSegment);
	modelsw.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 56.0f, 12.0f));
	meshesw.push_back(woodenSegment);
	modelsw.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 76.0f, -32.0f));
	meshesw.push_back(woodenSegment);
	modelsw.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 96.0f, -32.0f));
	meshesw.push_back(woodenSegment);
	modelsw.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 116.0f, -32.0f));
	meshesw.push_back(woodenSegment);
	modelsw.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-60.0f, 48.0f, -3.0f));
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(0.0f, 48.0f, 0.0f));
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-60.0f, 60.0f, -38.0f));
	meshesm.push_back(metallicSegment);
	modelsm.push_back(model);
	...
	model = glm::mat4(1.0f);
	model = glm::rotate(model, glm::radians(angle), glm::vec3(0.0f, 1.0f, 0.0f));
	model = glm::translate(model, glm::vec3(-60.0f, 23.0f, 28.0f));
	meshesm.push_back(metallicSegment);
	modelsm.push_back(model);
